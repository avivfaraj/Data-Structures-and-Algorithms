...
class DoublyLinkedList():
    ...
    def display(self,
        ...
        if current_node is not None:
            if ((forward and current_node.next) or
               (not forward and current_node.previous)):
...
def test() -> None:
    ...
    assert doubly_ls.is_empty() is True
    doubly_ls.insert(10)
    doubly_ls.insert(20)
    doubly_ls.insert(30)
    assert doubly_ls.delete(10) is True
    print(doubly_ls)
    ...
    assert doubly_ls.search(10) is False
    assert doubly_ls.search(20) is True
    assert doubly_ls.is_empty() is False
